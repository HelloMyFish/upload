...
public class RSAUtils2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        RSAPrivateKey rsaPrivateKey = (RSAPrivateKey) RSAUtils2.generateRSAPrivateKey(new BigInteger(modulus, 16).toByteArray(), new BigInteger(privateExponent, 16).toByteArray());
        byte[] de_result = RSAUtils2.decrypt(rsaPrivateKey, en_result);
